...
class Deblur_L(nn.Module):
    def __init__(self, num_feat=64, num_block=15):
        ...
        # propogation branch
        self.up = nn.Conv2d(num_feat, num_feat + num_feat//2, 1, 1, 0)
        self.down = nn.Conv2d(num_feat + num_feat//2, num_feat, 1, 1, 0)
        self.forward_propagation = manual_conv3d_propagation_forward(num_feat + num_feat//2, num_block)
        self.backward_propagation = manual_conv3d_propagation_backward(num_feat + num_feat//2, num_block)
    ...
    def forward(self, lrs):
        ...
        tf_wave1_l = self.down(tf_wave1_l)
