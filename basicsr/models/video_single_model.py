...
class VideoSingleModel(VideoBaseModel):

    def __init__(self, opt):
        super(VideoSingleModel, self).__init__(opt)
        if self.is_train:
    ...
    def optimize_parameters(self, current_iter):
        ...
        super(VideoSingleModel, self).optimize_parameters(current_iter)
