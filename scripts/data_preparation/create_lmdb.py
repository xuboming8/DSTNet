...
def create_lmdb_for_gopro():
    ...
    # train_gt
    folder_path = '/media/xbm/data/VideoDeblur_Dataset/GOPRO/GOPRO/train/gt'
    lmdb_path = '/media/xbm/data/VideoDeblur_Dataset/GOPRO/GOPRO/train/train_gt.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # train_blur
    folder_path = '/media/xbm/data/VideoDeblur_Dataset/GOPRO/GOPRO/train/blur'
    lmdb_path = '/media/xbm/data/VideoDeblur_Dataset/GOPRO/GOPRO/train/train_blur.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset',
        type=str,
        help=("Options: 'DIV2K', 'REDS', 'Vimeo90K', 'GOPRO' "
